...
export const chords: Chord[] = [
  ...
  // ── MAJOR ─────────────────────────────────────────────────────────────────
  { name: 'C',  type: 'major', strings: ['x','o',2,0,1,'o'], fingers: [0,0,2,0,1,0], baseFret: 1 },
  { name: 'C#', type: 'major', strings: ['x',4,6,6,6,4],    fingers: [0,1,3,4,5,1], baseFret: 4 },
  { name: 'D',  type: 'major', strings: ['x','x','o',2,3,2],fingers: [0,0,0,1,3,2], baseFret: 1 },
  { name: 'D#', type: 'major', strings: ['x','x',1,3,4,3],  fingers: [0,0,1,2,4,3], baseFret: 5 },
  ...
  { name: 'A#', type: 'major', strings: ['x',1,3,3,3,1],    fingers: [0,1,2,3,4,1], baseFret: 1 },
  { name: 'B',  type: 'major', strings: ['x',2,4,4,4,2],    fingers: [0,1,3,4,5,1], baseFret: 2 },
  ...
  { name: 'D#m', type: 'minor', strings: ['x','x',1,3,4,2], fingers: [0,0,1,3,4,2], baseFret: 5 },
  ...
  { name: 'D#7', type: '7th', strings: ['x','x',1,3,2,3],   fingers: [0,0,1,3,2,4], baseFret: 5 },
  ...
  { name: 'D#maj7', type: 'maj7', strings: ['x','x',1,3,3,3],      fingers: [0,0,1,2,3,4], baseFret: 5 },
  ...
  { name: 'D#dim', type: 'dim', strings: ['x','x',1,2,4,2],   fingers: [0,0,1,2,4,3], baseFret: 5 },
  ...
  { name: 'Aaug',  type: 'aug', strings: ['x','o',2,1,1,'o'], fingers: [0,0,3,1,2,0], baseFret: 1 },
  { name: 'Baug',  type: 'aug', strings: ['x',2,1,4,3,'x'],   fingers: [0,2,1,4,3,0], baseFret: 1 },

  // ── SUS2 ──────────────────────────────────────────────────────────────────
  { name: 'Csus2',  type: 'sus2', strings: ['x',3,5,5,3,3],   fingers: [0,1,3,4,1,1], baseFret: 3 },
  { name: 'Dsus2',  type: 'sus2', strings: ['x','x','o',2,3,5],fingers: [0,0,0,1,2,4], baseFret: 1 },
  ...
  // ── SUS4 ──────────────────────────────────────────────────────────────────
  { name: 'Csus4',  type: 'sus4', strings: ['x',3,3,5,6,6],   fingers: [0,1,1,3,4,4], baseFret: 3 },
  ...
  { name: 'Fsus4',  type: 'sus4', strings: [1,3,3,3,1,1],     fingers: [1,3,4,5,1,1], baseFret: 1 },
  { name: 'Gsus4',  type: 'sus4', strings: [3,3,'o','o',1,3], fingers: [3,4,0,0,1,5], baseFret: 1 },
  ...
  { name: 'Dadd9',  type: 'add9', strings: ['x','x','o',2,3,5], fingers: [0,0,0,1,2,4], baseFret: 1 },
  { name: 'Eadd9',  type: 'add9', strings: ['o',2,2,1,2,'o'],   fingers: [0,2,3,1,4,0], baseFret: 1 },
  { name: 'Gadd9',  type: 'add9', strings: [3,2,'o',2,'o',3],   fingers: [2,1,0,3,0,4], baseFret: 1 },
  { name: 'Aadd9',  type: 'add9', strings: ['x','o',2,2,2,2],   fingers: [0,0,1,2,3,4], baseFret: 1 },
  { name: 'Badd9',  type: 'add9', strings: ['x',2,4,4,4,4],     fingers: [0,1,2,3,4,5], baseFret: 2 },
];
